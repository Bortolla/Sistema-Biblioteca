    ...
    <div class="form">
        ...
        <form class="form-cadastro" action="cadastrar.php" method="post"> <!-- Formulario de cadastro para acessar o sistema -->
            ...
            <div class="lastname container">
                ...
                <input type="text" placeholder="Insira o sobrenome" name="lastname" id="lastname" value="<?php if(isset($_lastname)){echo $_lastname;}?>"><br>
                <div><?php if(isset($error_lastname)){echo $error_lastname;}?></div>
            </div>
            <div class="email container">
                <label for="email">Email:</label>
                <input type="email" placeholder="Insira o email" name="email" id="email" value="<?php if(isset($_email)){echo $_email;}?>"><br>
                <div><?php if(isset($error_email)){echo $error_email;}?></div>
            </div>
            <div class="phone container">
                <label for="phone">Telefone:</label>
                <input type="tel" placeholder="Insira o telefone" name="phone" id="phone" value="<?php if(isset($_phone)){echo $_phone;}?>"><br>
